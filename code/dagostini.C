...
void drawDagostini(string type) {
  ...
  c1->SaveAs(Form("roounfold_matrix_%s_%s.pdf",a,t));
  c1b->SaveAs(Form("roounfold_matrix0_%s_%s.pdf",a,t));
  ...
  c2->SaveAs(Form("roounfold_comparison_%s_%s.pdf",a,t));

  c3->cd(2);
  tex->DrawLatex(0.50, 0.85, Form("%s %s",t,a));
  c3->cd(0);
  //cmsPrel(type=="DATA" ? _jp_lumi : 0, true);
  c3->SaveAs(Form("roounfold_ratiotofwd_%s_%s.pdf",a,t));
